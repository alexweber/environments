 ...
 *
 * Customizes the CTools Exportable UI for Environments.
 */
class environments_environments_ctools_export_ui_handler extends environments_ctools_export_ui {
  ...
  function list_build_row($item, &$form_state, $operations) {
    ...
    $data = array(
      array(
        'data' => check_plain($item->alias),
        'class' => array('ctools-export-ui-alias'),
      ),
    );
